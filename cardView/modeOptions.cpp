...
void modeChooser::modeManager(DeckModes newMode) {
    ...
    ui->ButtonBoxes->setChecked(false);
    ui->ButtonSM2->setChecked(false);
...
void modeChooser::on_ButtonSM2_clicked()
{
    modeManager(SM2);
}
...
void modeChooser::on_sm2InfoButton_clicked()
{
    qInfo() << "Full SM-2 (SuperMemo 2) algorithm, like Anki's scheduler. Cards are scheduled with ease factors, intervals, and due dates. The most effective spaced repetition method.";
}
