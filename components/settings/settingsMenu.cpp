...
void settingsMenu::on_cramButton_clicked()
{
    qDebug() << "settingsMenu::on_cramButton_clicked";
    emit tellDeck("cram");
    this->close();
}

void settingsMenu::on_filterButton_clicked()
{
    qDebug() << "settingsMenu::on_filterButton_clicked";
    emit tellDeck("filter");
    this->close();
}

void settingsMenu::on_suspendButton_clicked()
{
    qDebug() << "settingsMenu::on_suspendButton_clicked";
    emit tellDeck("suspend");
    this->close();
}

void settingsMenu::on_buryButton_clicked()
{
    qDebug() << "settingsMenu::on_buryButton_clicked";
    emit tellDeck("bury");
    this->close();
}

void settingsMenu::on_flagButton_clicked()
{
    qDebug() << "settingsMenu::on_flagButton_clicked";
    emit tellDeck("flag");
    this->close();
}

void settingsMenu::on_minimalButton_clicked()
{
    qDebug() << "settingsMenu::on_minimalButton_clicked";
    emit tellDeck("minimal");
    this->close();
}
